 ...
 * class id= "17246"
 */
public class stdPortal extends javax.swing.JFrame {
int id;
...
PreparedStatement pst=null;
    ...
    public stdPortal(int id) {
        this.id=id;
        initComponents();
        String sql = "select * from stdcourse where (stdid=?)";
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stdPortal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
