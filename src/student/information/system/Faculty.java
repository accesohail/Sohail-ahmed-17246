...
/**
 *
 * @author Name= Sohail class Id="17246"*/
...
PreparedStatement pst=null;
    ...
    public Faculty(int id) {
        ...
        this.id=id;
        initComponents();
        String sql = "select * from faculty where (fcid=?)";
            try{
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student/information/system/images/Add.png"))); // NOI18N
        jLabel1.setText("Welcome To faculty portal");
