    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        System.out.println(user);
          String sql = "select id,username,password,division from Users Where (username =? and password =? and division =?)";
             if(user.equalsIgnoreCase(i) && txt_password.getText().equalsIgnoreCase(x) ){
        ...
        try{
           ...
           if(txt_username.getText().toString()=="sohail"){
               int id = rs.getInt(1);
          ...
          String access=(txt_combo.getSelectedItem().toString());
           ...
           if(access=="Student"){
               ...
               String sql1 = "select stdid,stdname,stdpass from student Where (stdname =? and stdpass =?)";
           ...
           rs1=pst1.executeQuery();
             while(rs1.next()){
                ...
                stdPortal s=new stdPortal(rs1.getInt((1)));
           ...
           if(access=="Faculty"){
               ...
               int count1=0;
               conn1=database.java_db();
               String sql1 = "select fcid,fcname,fcpass from faculty Where (fcname =? and fcpass =?)";
               pst1=conn1.prepareStatement(sql1);
